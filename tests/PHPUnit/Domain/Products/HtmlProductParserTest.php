...
class HtmlProductParserTest extends TestCase
{
     ...
     * @test
     */
    public function it_throws_an_exception_if_an_xpath_query_does_return_an_item(): void
    {
        $this->expectException(CouldNotListHtmlProducts::class);
        $sut = new HtmlProductParser();
        $html = '<html lang="en"><body><div class="package"></div></body></html>';
